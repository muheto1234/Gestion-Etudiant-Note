...
class Note(models.Model):
    ...
    etudiant=models.ForeignKey(Etudiant,on_delete=models.CASCADE) #relation avec la table Etrudiant
    cours=models.ForeignKey(Cour,on_delete=models.CASCADE) #relation avec la table Cour
